...
Document(page_content='Python is a versatile and widely used programming language known for 
its clean and readable syntax, which relies on indentation for code structure',
 metadata={'page': 1, 'source': 'document 1'})]
